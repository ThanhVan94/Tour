            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg">
                ...
                <a class="dropdown-item" href="#">
                    <div class="message">
                        <div class="py-3 mr-3 float-left">
                            <div class="avatar">
                                <img class="img-avatar" src="{{asset('/admin/img/avatars/7.jpg')}}">
                ...
                <a class="dropdown-item" href="#">
                    <div class="message">
                        <div class="py-3 mr-3 float-left">
                            <div class="avatar">
                                <img class="img-avatar" src="{{asset('/admin/img/avatars/5.jpg')}}">
                ...
                <a class="dropdown-item" href="#">
                    <div class="message">
                        <div class="py-3 mr-3 float-left">
                            <div class="avatar">
                                <img class="img-avatar" src="{{asset('/admin/img/avatars/4.jpg')}}" alt="admin@bootstrapmaster.com">
